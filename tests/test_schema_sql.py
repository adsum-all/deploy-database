...
def test_table_count(offline_sql: str) -> None:
    ...
    assert offline_sql.count("create table ") == 82  # + groupe_permission (0076)
...
def test_rls_enabled_on_every_table(offline_sql: str) -> None:
    ...
    assert offline_sql.count("enable row level security") == 82  # + groupe_permission (0076)
...
def test_rls_role_policies_created(offline_sql: str) -> None:
    ...
    assert offline_sql.count("create policy ") == 81  # + 2 policies groupe_permission (0076)
